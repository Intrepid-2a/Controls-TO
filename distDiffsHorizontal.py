...
def getHorizontalRunDistanceDifferences(ID=None, hemifield=None, location=None, runtrials=0, log=None):
    ...
    # print(type(participantfiles[0]))

    # print(participantfiles)
...
#     # get everything shared from central:
    setup = localizeSetup(location=location, trackEyes=trackEyes, filefolder=eyetracking_path, filename='NONE_1', task='distHorizontal', ID=ID) # data path is for the mapping data, not the eye-tracker data!
...
#     # unpack all this
    win = setup['win'] # this is now... FALSE!
