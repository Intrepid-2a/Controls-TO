...
def getHorizontalRunDistanceDifferences(ID=None, hemifield=None, location=None):
    ...
    respFileName = data_path + filename + str(x-1) + '.txt'
    # respFile = open(respFileName,'w')

    # NO !
    # open with PANDAS as a data frame?
