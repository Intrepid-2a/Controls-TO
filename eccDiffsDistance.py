...
def getDistanceRunDistanceDifferences(ID=None, hemifield=None, location=None, runtrials=0, log=None):
    ...
    recoveredFileName = ID + '_dist_' + ('LH' if hemifield == 'left' else 'RH') + '_1.txt'
    ...
    print([location, trackEyes, eyetracking_path])
    ...
    # data path is for the mapping data, not the eye-tracker data!

    # print(setup['paths']) # not using yet, just testing

    # unpack all this
    win = setup['win'] # should be FALSE now
