...
def doColorCalibration(ID=None, task=None, location=None):
    ...
    if ID == None:
        ...
        askQuestions = True
    if task == None:
        expInfo['task'] = ['distHorizontal', 'distBinocular', 'distScaled', 'distCentred', 'distRotated','distUpturned','distUpshifted','distAsynchronous','distScaledAsynchronous','distScaledAsynchronousOFS','distUpScaledAsynchronous','distAsynchronousNAM']
        askQuestions = True
    # if location == None:
